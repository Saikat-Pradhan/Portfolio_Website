  ...
  return (
    <div className='h-screen lg:h-fit  bg-neutral-900 pt-[2cm] lg:py-5'>
      <div>
        ...
        <BiSolidDownload
          className="absolute top-[14cm] lg:top-[16cm] right-7 size-[2rem] p-[1px] rounded-full text-black bg-white border-[2px] border-black cursor-pointer animate-bounce"
